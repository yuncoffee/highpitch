...
class ProjectMock {
    ...
    let sampleProject1 = ProjectModel(
        projectName: "스위프트로 시작하는 디자인시스템",
        creatAt: "2023. 12. 2. 오후 4:39",
        keynoteCreation: "temp"
    )
    let sampleProject2 = ProjectModel(
        projectName: "Xcode 소개하기",
        creatAt: "2023. 12. 2. 오후 3:29",
        keynoteCreation: "temp"
    )
}
...
class SampleDigDaPracticesMock1 {
    ...
    var summary = PracticeSummaryModel(
        ...
        slowSentenceIndex: [8, 9, 13, 17, 22],
...
class SampleDigDaPracticesMock4 {
    ...
    let practice = PracticeModel(
        ...
        index: 1,
        isVisited: true,
        creatAt: "2023-12-03 23:26:45 GMT+09:00",
        audioPath: URL(fileURLWithPath: URL.getPath(fileName: "20231203234211", type: .audio).path()),
        videoPath: URL(fileURLWithPath: URL.getPath(fileName: "20231203234211", type: .video).path()),
        utterances: [],
        words: [],
...
class SampleDigDaPracticesMock5 {
    ...
    let practice = PracticeModel(
        ...
        index: 2,
        isVisited: true,
        creatAt: "2023-12-03 23:26:55 GMT+09:00",
        audioPath: URL(fileURLWithPath: URL.getPath(fileName: "20231203234211", type: .audio).path()),
        videoPath: URL(fileURLWithPath: URL.getPath(fileName: "20231203234211", type: .video).path()),
        utterances: [],
        words: [],
...
class SampleDigDaPracticesMock6 {
    ...
    let practice = PracticeModel(
        ...
        index: 3,
        isVisited: true,
        creatAt: "2023-12-03 23:27:55 GMT+09:00",
        audioPath: URL(fileURLWithPath: URL.getPath(fileName: "20231203234211", type: .audio).path()),
        videoPath: URL(fileURLWithPath: URL.getPath(fileName: "20231203234211", type: .video).path()),
        utterances: [],
        words: [],
...
class SampleDigDaPracticesMock7 {
    ...
    let practice = PracticeModel(
        ...
        index: 4,
        isVisited: true,
        creatAt: "2023-12-03 23:35:11 GMT+09:00",
        audioPath: URL(fileURLWithPath: URL.getPath(fileName: "20231203232635", type: .audio).path()),
        videoPath: URL(fileURLWithPath: URL.getPath(fileName: "20231203232635", type: .video).path()),
        utterances: [],
        words: [],
